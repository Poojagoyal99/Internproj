...
<div className="bg-customSkin h-screen flex items-center justify-center">
                    ...
                    <div className="w-full md:w-1/2 p-8">
                        ...
                        <form onSubmit={handleLogin}>
                            <div className="mb-5">
                                ...
                                <input type="email" id="email" placeholder="Enter your Email here" value={email}
            ...
            className="w-full p-2 pl-8 border bg-gray-300 rounded-xl mt-2" />
                            ...
                            {error && <p>{error}</p>}
                                <button type="submit" className="w-3/6 bg-customBrown text-white py-2 rounded-lg" onClick={navigateToAbout}>LOGIN</button>
                            </div>

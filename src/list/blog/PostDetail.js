        ...
        <>
            ...
            <div className="flex flex-col lg:flex-row md:mx-32 md:my-24 space-x-10">
                <div className="w-fit lg:w-1/2 mx-5 my-5">
                    <img src={postImg} alt="imageOfPost" className="h-96 w-full object-cover" />
                </div>
                <div className="w-fit lg:w-1/2 mx-5 my-5 mr-10">
                    ...
                    <p className="text-gray-500 text-base pt-4 mb-4">

...
const AllBlog = () => {
  return (
    <>
      <h1 className="font-semibold text-2xl mx-4 lg:mx-36">Recent Blog Posts</h1>
      <div className="flex flex-col lg:flex-row space-y-6 lg:space-x-6 mt-10 lg:mx-36">
        <Link to='/postdetails' className="lg:w-1/3">
          <img src={blog11} alt="blogImage" className="w-full"></img>
        ...
        <Link to='/postdetails' className="flex flex-col lg:flex-row lg:w-2/3 space-y-4 lg:space-y-0 lg:space-x-4">
          <div className="lg:w-1/2">
            <img src={blog12} alt="blogImage" className="w-full h-80 object-cover"></img>
          </div>
          <div className="lg:w-1/2">
            <p className="font-bold text-purple-600 pt-3">Name 1 Jan 2023</p>
      ...
      <div className="grid grid-cols-1  lg:grid-cols-2 xl:grid-cols-3 gap-4 mt-10 lg:mx-36">
        {[blog1, blog2, blog3, blog4, blog5, blog6].map((blog, index) => (
          <Link to='/postdetails' key={index} className="flex flex-col space-y-3">
            <img src={blog} alt={`blogImage${index + 1}`} className="w-full mt-10"></img>

...
const PickUp = () => {
    ...
    return(
        ...
        <div className='mx-28 my-20 min-h-96 w-5/6 rounded-2xl shadow-2xl shadow-slate-500 flex flex-row space-x-10'>
          <div className='ml-28 min-h-96 w-1/3 mt-10 bg-customCream rounded-2xl'>
  ...
  <div className='h-10 w-10 mt-1 ml-10 pt-1 bg-gray-400 rounded-full'><span className='text-white text-2xl pl-3 font-bold'>3</span></div>
      ...
      <div className="flex flex-wrap mb-6">
        <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
          ...
          <input
            className="appearance-none block w-full bg-transparent border-b-2 border-gray-300 text-gray-700 py-2 px-4 leading-tight focus:outline-none focus:border-blue-500"
            type="text"

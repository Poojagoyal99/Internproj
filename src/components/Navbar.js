...
<nav className="bg-customSkin p-4">
      <div className="container mx-auto flex justify-between items-center">
        <div className="text-white text-lg font-bold"><button onClick={navigateToAbout2}><img src={logo} alt='logoImage'></img></button></div>
        <div className="flex space-x-4">
          <button href="#" className="text-white hover:text-gray-400 px-20" onClick={navigateToAbout}>Discover</button>
